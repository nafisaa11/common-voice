...
export type CommonVoiceConfig = {
  ...
  FORCE_IMPORT_SENTENCES: boolean
  REDIS_URL: string
  LAST_DATASET: string
...
const BASE_CONFIG: CommonVoiceConfig = {
  ...
  FORCE_IMPORT_SENTENCES: configEntry('CV_FORCE_IMPORT_SENTENCES', false, castBoolean),
  ...
  USE_LOCAL_STORAGE: configEntry('CV_USE_LOCAL_STORAGE', false, castBoolean),
  STORAGE_PUBLIC_URL: configEntry('CV_STORAGE_PUBLIC_URL', undefined),
}
